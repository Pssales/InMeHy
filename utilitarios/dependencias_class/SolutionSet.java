...
import dependencias_class.Solution;
...
public class SolutionSet implements Serializable {
  ...
  protected final List<Solution> solutionsList_test;
  ...
  public SolutionSet() {
    ...
    solutionsList_test = new ArrayList<Solution>();
  } // SolutionSet
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  public void meuMetodoConverte(List<IntegerSolution> solucao){
	  
	  for(IntegerSolution s : solucao){
		  Solution sol = new Solution(2);
		  sol.setObjective(0, s.getObjective(0));
		  sol.setObjective(1, s.getObjective(1));
		  solutionsList_.add(sol.clonar());  
	  }
  ...
  */
  ...
  public SolutionSet union_final(SolutionSet solutionSet) {       
  ...
  public void printObjectives() {
	System.out.println("lalazinha"+solutionsList_.size());
    for (int i = 0; i < solutionsList_.size(); i++)
      System.out.println(""+ solutionsList_.get(1)) ;
  }
  ...
  public SolutionSet clonar(){
	  SolutionSet clone = new SolutionSet(capacity_);
