...
import dependencias_abstract.SolutionType;
import dependencias_abstract.Variable;
...
public class Solution implements Serializable {  
  ...
  public Solution clonar(){
	  Solution clone = new Solution(numberOfObjectives_);
	  clone.setObjective(0, getObjective(0));
	  clone.setObjective(1, getObjective(1));
	  return clone;
  }
