...
import dependencias_class.RepairDoubleSolutionAtBounds;
...
public class IntegerCDGMutation implements MutationOperator<IntegerSolution> {
  ...
  /** Constructor */
  public IntegerCDGMutation() {
    this(DEFAULT_PROBABILITY, DEFAULT_DELTA) ;
  }

  /** Constructor */
  public IntegerCDGMutation(DoubleProblem problem, double delta) {
    this(1.0/problem.getNumberOfVariables(), delta) ;
  }

  /** Constructor */
  public IntegerCDGMutation(double mutationProbability, double delta) {
