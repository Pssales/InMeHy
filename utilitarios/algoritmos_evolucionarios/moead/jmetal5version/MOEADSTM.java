...
public class MOEADSTM extends AbstractMOEAD<IntegerSolution> {
  ...
  public MOEADSTM(Problem<IntegerSolution> problem, int populationSize, int resultPopulationSize,
                  int maxEvaluations,
                  MutationOperator<IntegerSolution> mutation, CrossoverOperator<IntegerSolution> crossover,
   ...
   */
  public double calculateDistance(IntegerSolution individual, double[] lambda) {
    double scale;
    double distance;
   ...
   * Calculate the perpendicular distance between the solution and reference line
   */
  public double calculateDistance2(IntegerSolution individual, double[] lambda) {
