...
public class NSGAIII_LLH_IntegerProblem extends AbstractAlgorithmRunner {
	...
	public NSGAIII_LLH_IntegerProblem(Problem<IntegerSolution> problem, int _populationSize, double _crossoverProbability, double _mutationProbability, int _operador_crossover, int _operador_mutacao, int _numberValidations ) throws IOException{
