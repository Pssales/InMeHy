...
public class IBEA<S extends Solution<?>> implements Algorithm<List<S>> {
 ...
 //   System.out.println("chama problem.createSolution()");	
      newSolution = problem.createSolution();
      problem.evaluate(newSolution);
      evaluations++;
      solutionSet.add(newSolution);
 //     System.out.println("SolutionSet: "+solutionSet.size());
    }
   // System.out.println(evaluations+" + "+maxEvaluations);
    
    while (evaluations < maxEvaluations) {
    //	System.out.println("SolutionSettt: "+solutionSet.size());
...
//	  System.out.println("getResult() "+archive.size());
