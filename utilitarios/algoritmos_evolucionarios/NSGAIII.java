...
import dependencias_class.EnvironmentalSelection;
import dependencias_class.JMetalLogger;
import dependencias_class.ReferencePoint;
...
public class NSGAIII<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
  ...
  public NSGAIII(NSGAIIIBuilder<S> builder) { // can be created from the NSGAIIIBuilder within the same package
   ...
   // eu comentei JMetalLogger.logger.info("rpssize: " + referencePoints.size()); ;
  }
