...
public class MOMBI_LLH_IntegerProblem extends AbstractAlgorithmRunner {
	...
	public MOMBI_LLH_IntegerProblem(Problem<IntegerSolution> problem, double _crossoverProbability, double _mutationProbability, int _operador_crossover, int _operador_mutacao, int _numberValidations, String weight_path) throws IOException{
	...
	public Saida execute() throws IOException{
		    ...
		    algorithm = new MOMBI<>(problem,maxEvaluations,crossover,mutation,selection,new SequentialSolutionListEvaluator<IntegerSolution>(),
		    		weight_path);
